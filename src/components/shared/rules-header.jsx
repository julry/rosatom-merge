...
export const RulesHeader = ({onClick, className, initialTime, isStart, onFinish, onRestart}) => {
    ...
    return (
        ...
        <RulesWrapper className={className}>
            <Timer initialTime={initialTime} isStart={isStart} onFinish={handleFinish} />
        ...
        {isFinished && <TimeOutModal onRestart={handleRestart} />}
        </>
    );
}